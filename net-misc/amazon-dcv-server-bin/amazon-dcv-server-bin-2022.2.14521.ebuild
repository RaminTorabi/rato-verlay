...
# 2022.2 did not ship an el9 tarball — use el8. The RPM still runs on
# modern Gentoo hosts since DCV bundles its own shared libs.
MY_PV_DASH="${PV%.*}-${PV##*.}"
SRC_URI="https://d1uj6qtbmh3dt5.cloudfront.net/${PV%.*}/Servers/nice-dcv-${MY_PV_DASH}-el8-x86_64.tgz -> ${P}.tgz"
